...
- Name: auth.spec.ts >> Authentication Flow >> logs in using HAR-mocked /auth/login response
- Location: e2e\auth.spec.ts:219:7
...
```
Error: browserContext.newPage: Test timeout of 90000ms exceeded.
```
